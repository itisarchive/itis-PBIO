...
Repository that contains solutions to the programming exercises for the PBIO (Basics of Bioinformatics) practical
classes, taught by various teachers during studies on [PJAIT](https://www.pja.edu.pl/en/).
